...
|-------------|----------|------------|
| Exploring ideas, brainstorming, "what if" | Analyst (Mary) | `BMAD Universal/agents/analyst.md` |
| Defining features, requirements, "what should it do" | PM (John) | `BMAD Universal/agents/pm.md` |
| User experience, interface design, "how should it feel" | UX Designer (Sally) | `BMAD Universal/agents/ux-designer.md` |
| System design, tech decisions, "how should it be built" | Architect (Winston) | `BMAD Universal/agents/architect.md` |
| Organizing work, creating stories, "what's next" | SM (Bob) | `BMAD Universal/agents/sm.md` |
| Writing code, implementing features, "build this" | Developer (Amelia) | `BMAD Universal/agents/dev.md` |
| Testing, quality, CI/CD, "is it working correctly" | TEA (Murat) | `BMAD Universal/agents/tea.md` |
| Documentation, writing guides | Tech Writer (Paige) | `BMAD Universal/agents/tech-writer.md` |
| Quick fixes, small features, rapid work | Quick Flow (Barry) | `BMAD Universal/agents/quick-flow-solo-dev.md` |
| Creative ideation, generating many ideas | Brainstorm Coach (Carson) | `BMAD Universal/agents/brainstorming-coach.md` |
| Solving complex problems, root cause | Problem Solver (Dr. Quinn) | `BMAD Universal/agents/creative-problem-solver.md` |
| Human-centered design, empathy mapping | Design Thinking (Maya) | `BMAD Universal/agents/design-thinking-coach.md` |
| Business strategy, disruption, innovation | Innovation Strategist (Victor) | `BMAD Universal/agents/innovation-strategist.md` |
| Presentations, visual communication | Presentation Master (Caravaggio) | `BMAD Universal/agents/presentation-master.md` |
| Narratives, storytelling, messaging | Storyteller (Sophia) | `BMAD Universal/agents/storyteller.md` |
| Multi-agent discussion, complex decisions | Party Mode | `BMAD Universal/agents/party-mode.md` |
| Creating custom agents/workflows | Builder | `BMAD Universal/agents/bmad-builder.md` |
| Meta questions about BMAD itself | BMAD Master | `BMAD Universal/agents/bmad-master.md` |
| Version info, updates, compatibility | BMAD Updater | `BMAD Universal/agents/bmad-updater.md` |
...
4. **Load Agent File** - Read the complete agent persona from `BMAD Universal/agents/[agent-name].md`
...
See: BMAD Universal/workflows/[path]/[workflow].md
```

## CONFIGURATION

Load project settings from `BMAD Universal/config.yaml`:
```yaml
...
Route to: **BMAD Updater** (`BMAD Universal/agents/bmad-updater.md`)
